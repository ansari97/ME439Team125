...
#ifndef XARMROB_INTERFACES__SRV__DETAIL__ME439_X_ARM_FORWARD_KINEMATICS__FUNCTIONS_H_
#define XARMROB_INTERFACES__SRV__DETAIL__ME439_X_ARM_FORWARD_KINEMATICS__FUNCTIONS_H_
...
/// Initialize srv/ME439XArmForwardKinematics message.
/**
 ...
 * )) before or use
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__create()
...
/// Finalize srv/ME439XArmForwardKinematics message.
/**
...
/// Create srv/ME439XArmForwardKinematics message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__init().
...
/// Destroy srv/ME439XArmForwardKinematics message.
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__fini()
...
/// Check for srv/ME439XArmForwardKinematics message equality.
/**
...
/// Copy a srv/ME439XArmForwardKinematics message.
/**
...
/// Initialize array of srv/ME439XArmForwardKinematics messages.
/**
...
/// Finalize array of srv/ME439XArmForwardKinematics messages.
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__fini()
...
/// Create array of srv/ME439XArmForwardKinematics messages.
/**
 * It allocates the memory for the array and calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ME439XArmForwardKinematics messages.
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ME439XArmForwardKinematics message array equality.
/**
...
/// Copy an array of srv/ME439XArmForwardKinematics messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * )) before or use
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Response__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It allocates the memory for the array and calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * )) before or use
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Event__create()
 * to allocate and initialize the message.
 * \return true if initialization was successful, otherwise false
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It allocates the memory for the array and calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_xarmrob_interfaces
...
/**
 * It calls
 * xarmrob_interfaces__srv__ME439XArmForwardKinematics_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // XARMROB_INTERFACES__SRV__DETAIL__ME439_X_ARM_FORWARD_KINEMATICS__FUNCTIONS_H_
