...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->endpoint, 0)) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__fini(msg);
    return false;
  }
  // effector_pose
  {
    bool success = rosidl_runtime_c__float__Sequence__init(&msg->effector_pose, 9);
    if (!success) {
      goto abort_init_0;
    }
  }
  msg->effector_pose.data[0] = 0.0f;
  msg->effector_pose.data[1] = 0.0f;
  msg->effector_pose.data[2] = 0.0f;
  msg->effector_pose.data[3] = 0.0f;
  msg->effector_pose.data[4] = 0.0f;
  msg->effector_pose.data[5] = 0.0f;
  msg->effector_pose.data[6] = 0.0f;
  msg->effector_pose.data[7] = 0.0f;
  msg->effector_pose.data[8] = 0.0f;
  return true;
abort_init_0:
  return false;
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__fini(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * msg)
{
  ...
  // effector_pose
  rosidl_runtime_c__float__Sequence__fini(&msg->effector_pose);
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__are_equal(const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * lhs, const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * rhs)
{
  ...
  // effector_pose
  if (!rosidl_runtime_c__float__Sequence__are_equal(
      &(lhs->effector_pose), &(rhs->effector_pose)))
  {
    return false;
  }
  return true;
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * output)
{
  ...
  // effector_pose
  if (!rosidl_runtime_c__float__Sequence__copy(
      &(input->effector_pose), &(output->effector_pose)))
  {
    return false;
  }
  return true;
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__create(void)
{
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * msg = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request));
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__init(msg);
  if (!success) {
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * data = NULL;

  if (size) {
    data = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request *)allocator.zero_allocate(size, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__fini(&data[i - 1]);
      }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__fini(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * array = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__init(array, size);
  if (!success) {
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__destroy(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__are_equal(const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * lhs, const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request * data =
      (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__copy(
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response * msg)
{
  ...
  if (!rosidl_runtime_c__float__Sequence__init(&msg->joint_angles, 0)) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__fini(msg);
    return false;
  }
  // endpoint
  if (!rosidl_runtime_c__float__Sequence__init(&msg->endpoint, 0)) {
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response * msg = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response));
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response * data = NULL;

  if (size) {
    data = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response *)allocator.zero_allocate(size, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__fini(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * array = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__destroy(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__are_equal(const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * lhs, const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response * data =
      (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(msg);
    return false;
  }
  // request
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__init(&msg->request, 0)) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(msg);
    return false;
  }
  // response
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__init(&msg->response, 0)) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(msg);
    return false;
  }
  return true;
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * msg)
{
  ...
  // request
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__fini(&msg->request);
  // response
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__fini(&msg->response);
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__are_equal(const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * lhs, const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * rhs)
{
  ...
  // request
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__are_equal(
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * output)
{
  ...
  // request
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * msg = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event));
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__init(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * data = NULL;

  if (size) {
    data = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event *)allocator.zero_allocate(size, sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__fini(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * array = (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence *)allocator.allocate(sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__destroy(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence__are_equal(const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * lhs, const xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event * data =
      (xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!xarmrob_interfaces__srv__ME439XArmInverseKinematics_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
