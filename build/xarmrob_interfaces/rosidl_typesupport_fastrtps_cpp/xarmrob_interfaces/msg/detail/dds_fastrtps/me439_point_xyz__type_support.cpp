...
#include "xarmrob_interfaces/msg/detail/me439_point_xyz__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xarmrob_interfaces::msg::ME439PointXYZ;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const xarmrob_interfaces::msg::ME439PointXYZ *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<xarmrob_interfaces::msg::ME439PointXYZ *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ME439PointXYZ__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const xarmrob_interfaces::msg::ME439PointXYZ *>(
...
static size_t _ME439PointXYZ__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ME439PointXYZ(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ME439PointXYZ__callbacks = {
...
static rosidl_message_type_support_t _ME439PointXYZ__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ME439PointXYZ__callbacks,
...
{
  return &xarmrob_interfaces::msg::typesupport_fastrtps_cpp::_ME439PointXYZ__handle;
}
