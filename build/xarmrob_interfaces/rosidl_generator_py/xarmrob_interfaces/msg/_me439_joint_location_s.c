...
bool xarmrob_interfaces__msg__me439_joint_location__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xarmrob_interfaces.msg._me439_joint_location.ME439JointLocation", full_classname_dest, 63) == 0);
  }
  xarmrob_interfaces__msg__ME439JointLocation * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of ME439JointLocation */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("xarmrob_interfaces.msg._me439_joint_location");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ME439JointLocation");
  ...
  {  // z
    ...
    if (ros_message->z.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      float * src = &(ros_message->z.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->z.size * sizeof(float));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
