...
class Metaclass_ME439JointLocation(type):
    """Metaclass of message 'ME439JointLocation'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'xarmrob_interfaces.msg.ME439JointLocation')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__me439_joint_location
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__me439_joint_location
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__me439_joint_location
            cls._TYPE_SUPPORT = module.type_support_msg__msg__me439_joint_location
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__me439_joint_location
...
class ME439JointLocation(metaclass=Metaclass_ME439JointLocation):
    """Message class 'ME439JointLocation'."""
