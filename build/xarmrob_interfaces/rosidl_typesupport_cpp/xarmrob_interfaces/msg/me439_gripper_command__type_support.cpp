...
static const _ME439GripperCommand_type_support_symbol_names_t _ME439GripperCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, xarmrob_interfaces, msg, ME439GripperCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, xarmrob_interfaces, msg, ME439GripperCommand)),
  }
};
...
{
  return &::xarmrob_interfaces::msg::rosidl_typesupport_cpp::ME439GripperCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, xarmrob_interfaces, msg, ME439GripperCommand)() {
  return get_message_type_support_handle<xarmrob_interfaces::msg::ME439GripperCommand>();
}
